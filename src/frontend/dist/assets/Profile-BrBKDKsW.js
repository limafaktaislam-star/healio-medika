...
import { N as NurseStatusBadge } from "./StatusBadge-Cg08N2S-.js";
import { B as Button } from "./button-Dgh0anEC.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-D1BeUdJQ.js";
...
function NurseProfile() {
  ...
  const saveMutation = useMutation({
    mutationFn: async () => {
      ...
      const strUrl = strFile ? await uploadFile(strFile) : (profile == null ? void 0 : profile.strDocUrl) ?? "";
      const ktpUrl = ktpFile ? await uploadFile(ktpFile) : (profile == null ? void 0 : profile.ktpDocUrl) ?? "";
