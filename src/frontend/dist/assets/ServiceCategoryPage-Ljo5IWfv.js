import { e as useParams, a as useNavigate, r as reactExports, j as jsxRuntimeExports } from "./index-CogN6nIg.js";
...
import { u as useNearbyNurses } from "./useQueries-BuxrTd_z.js";
            ...
            "div",
            {
              ...
              children: [
                ...
                ProviderCard,
                {
                  ...
                  nightTime,
                  onBook: () => {
                    const isLoggedIn = localStorage.getItem("healio_role");
                    if (!isLoggedIn) {
                      ue.error(
