import { u as useAuth, a as useNavigate, r as reactExports, j as jsxRuntimeExports } from "./index-CogN6nIg.js";
...
import { H as Heart } from "./heart-Cx4_bTDj.js";
import { U as User } from "./user-Dr0P04w_.js";
import { S as Stethoscope, a as Shield } from "./user-check-Ds2Iu5HR.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { showSidebar: false, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        style: {
          background: "linear-gradient(135deg, #062b1e 0%, #0d4a35 35%, #133d2a 65%, #081f16 100%)"
        },
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  onMouseEnter: (e) => {
                    ...
                    el.style.boxShadow = "0 20px 48px rgba(0,0,0,0.22), inset 0 1px 0 rgba(255,255,255,0.5)";
                  },
                  onMouseLeave: (e) => {
                    const el = e.currentTarget;
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      ...
                      {
                        type: "button",
                        onClick: () => svc.category === "apotek" ? navigate({ to: "/apotek" }) : navigate({
                        ...
                        onMouseEnter: (e) => {
                          e.currentTarget.style.color = "#f5d76a";
                        },
                        onMouseLeave: (e) => {
