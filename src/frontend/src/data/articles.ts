...
const detailedArticles: ArticleData[] = [
  {
    ...
    imagePrompt:
      "Foto klinis modern dokter kardiologi memeriksa EKG pasien, ruang gawat darurat profesional, latar putih bersih steril, gaya Healio Medika Indonesia",
    references: [
  ...
  },
  {
    ...
    imagePrompt:
      "Foto klinis modern pengukuran tekanan darah pasien lansia oleh perawat homecare, latar putih Indonesia, gaya Healio Medika profesional",
    references: [
  ...
  },
  {
    ...
    imagePrompt:
      "Foto klinis modern pemeriksaan gula darah glukometer, pasien diabetes mandiri, latar putih steril, gaya Healio Medika Indonesia",
    references: [
  ...
  },
  {
    ...
    imagePrompt:
      "Foto klinis modern pasien menggunakan inhaler asma dengan spacer, dokter mendampingi, latar putih bersih, gaya Healio Medika Indonesia",
    references: [
  ...
  },
  {
    ...
    imagePrompt:
      "Foto klinis modern dokter saraf menjelaskan CT scan otak kepada keluarga pasien, konsultasi profesional, latar putih bersih, gaya Healio Medika Indonesia",
    references: [
  ...
  },
  {
    ...
    imagePrompt:
      "Foto klinis modern petugas fogging lingkungan DBD, Indonesia, gaya Healio Medika profesional",
    references: [
  ...
  },
  {
    ...
    imagePrompt:
      "Foto klinis modern dokter onkologi menjelaskan mamografi kepada pasien, konsultasi profesional, latar putih bersih, gaya Healio Medika Indonesia",
    references: [
  ...
  },
  {
    ...
    imagePrompt:
      "Foto klinis modern pemeriksaan DEXA scan kepadatan tulang, pasien wanita lansia, latar putih steril, gaya Healio Medika profesional",
    references: [
  ...
  },
  {
    ...
    imagePrompt:
      "Foto klinis modern pasien hemodialisis dengan perawat, mesin dialisis modern, latar putih bersih, gaya Healio Medika Indonesia",
    references: [
  ...
  },
  {
    ...
    imagePrompt:
      "Foto klinis modern sesi konseling antara terapis dan pasien, ruang konseling hangat profesional, latar putih bersih, gaya Healio Medika Indonesia",
    references: [
  ...
  },
  {
    ...
    imagePrompt:
      "Foto klinis modern dokter memeriksa rontgen dada pneumonia, latar putih steril, gaya Healio Medika profesional",
    references: [
  ...
  },
  {
    ...
    imagePrompt:
      "Foto klinis modern perawat homecare mengukur suhu pasien tifus, perawatan di rumah profesional, latar putih bersih, gaya Healio Medika Indonesia",
    references: [
      "WHO. Typhoid. who.int",
  ...
  },
  {
    ...
    imagePrompt:
      "Foto klinis modern petugas tes RDT malaria di puskesmas daerah terpencil Papua, gaya Healio Medika Indonesia",
    references: [
  ...
  },
  {
    ...
    imagePrompt:
      "Foto klinis modern perawat mengambil sampel darah untuk tes hemoglobin, latar putih bersih, gaya Healio Medika Indonesia",
    references: [
  ...
  },
  {
    ...
    imagePrompt:
      "Foto klinis modern tenaga kesehatan memberikan vaksinasi COVID-19, APD profesional, klinik modern bersih, gaya Healio Medika Indonesia",
    references: [
  ...
  },
  {
    ...
    imagePrompt:
      "Foto klinis modern pengukuran tinggi badan balita di posyandu, kader kesehatan Indonesia, latar cerah bersih, gaya Healio Medika",
    references: [
  ...
  },
  {
    ...
    imagePrompt:
      "Foto klinis modern bidan mengukur tekanan darah ibu hamil, klinik antenatal care profesional, latar putih bersih, gaya Healio Medika Indonesia",
    references: [
  ...
  },
  {
    ...
    imagePrompt:
      "Foto klinis modern pemeriksaan tekanan mata tonometer, dokter mata profesional, latar putih steril, gaya Healio Medika Indonesia",
    references: [
  ...
  },
  {
    ...
    imagePrompt:
      "Foto klinis modern dokter menjelaskan hasil tes hepatitis B, konsultasi profesional, latar putih bersih, gaya Healio Medika Indonesia",
    references: [
  ...
  },
  {
    ...
    imagePrompt:
      "Foto klinis modern fisioterapis melatih tangan pasien RA, tangan bengkak khas, rehabilitasi profesional, latar putih bersih, gaya Healio Medika Indonesia",
    references: [
...
const diseaseData: [string, string, string][] = [
  [
    "gagal-jantung",
...
const generatedArticles: ArticleData[] = diseaseData.map(
  ([slug, title, category], i) => ({
    ...
    imagePrompt:
      "Foto klinis modern tenaga medis profesional HEALIO MEDIKA merawat pasien, suasana homecare atau klinik bersih dan profesional, latar putih steril Indonesia",
    references: [
